...
builder.Services.AddDbContext<ClientsAuthDbContext>(options =>
options.UseSqlServer(builder.Configuration.GetConnectionString("ClientsAuthConnectionString")));
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddEntityFrameworkStores<ClientsAuthDbContext>()
